...
const CryptoThankyou = () => {
  ...
  useEffect(() => {
    const isRegistered = sessionStorage.getItem("cryptoRegistered");
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-[90%]  mx-auto py-20 md:py-14 gap-5">
          ...
          <div className="flex flex-col justify-center gap-5">
            ...
            <p className="text-gray-700 text-center order-3 md:order-2">
              ...
              bootcamp has been successful and you will be getting an email from
              us shortly. Please join our general WhatsApp group using the
              button below. If you encounter any difficulties joining, please
              send an email to{" "}
