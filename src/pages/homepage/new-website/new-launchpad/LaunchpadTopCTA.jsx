          ...
          <Fade bottom>
            <h2 className="font-semibold text-lg md:text-3xl lg:text-5xl leading-5">
              ...
              <span className="text-tech-blue relative inline-block">
                Techyjaunt{" "}
                <FancyUnderline className="absolute w-24 md:w-full" />
              </span>
            </h2>
          </Fade>
          <Fade bottom>
            <NavLink
              to="register"
              className="inline-block rounded-md mt-5 py-3 px-4 text-base md:text-lg bg-tech-blue text-white hover:bg-gray-500 transition-all ease-linear duration-200"
            >
              Apply now
            </NavLink>
          </Fade>
