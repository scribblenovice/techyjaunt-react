...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#E4FCFF] py-20 relative">
        <div className="flex w-[85%] mx-auto">
          ...
          <CardSlider />
          <div className="text-5xl absolute right-20 bottom-10 z-50">
            <button className="hover:text-white text-black bg-white  hover:bg-tech-blue">
