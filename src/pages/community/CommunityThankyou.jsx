    ...
    <div className="w-screen h-screen grid place-items-center bg-gradient-to-r from-blue-500 to-blue-700">
      <div className="grid place-items-center w-[90%] sm:w-[80%] gap-y-5">
        ...
        <p className="text-center text-xl sm:text-2xl md:text-4xl text-white font-bold">
          Your registration to join the TechyJaunt community has been
          successful!
          <br />
          <span className="text-sm md:text-base">
            {" "}
            Please join our general WhatsApp group by clicking the button below.
            If you encounter any difficulties joining, please send an email to
            support@techyjaunt.com for assistance.
            <br />
            Welcome aboard!
          </span>
        </p>
        <a
          target="_blank"
          href="https://chat.whatsapp.com/GrWTvqGpf742giBu1BOZsE"
          // onClick={redirect}
