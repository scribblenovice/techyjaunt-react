            ...
            <div className="h-full lg:h-[70%] flex flex-col justify-around md:justify-evenly">
              ...
              <Fade bottom>
                <p className="font-medium text-white text-base md:text-lg leading-8 glow">
                  Start an exciting tech journey with help and mentorship from
                  industry experts. Learn important tech skills from anywhere in
                  the world. Begin your adventure into tech today!
                </p>
                <button
            ...
            <div className="w-[90%] sm:w-[80%] mx-auto grid grid-cols-1 place-items-center py-10">
              <div className="lg:w-[100%]">
                ...
                <p className="font-normal text-white mb-5 text-base leading-8">
                  Join us for a fun tech experience where you can learn
                  important tech skills with the help of expert mentors. Our
                  students come from many different places, all wanting to
                  succeed in tech. You’re just one click away from starting your
                  journey in exciting tech fields. Take the first step towards
                  your tech future today!
                </p>
                <button
                  onClick={() => setOpenModal(true)}
