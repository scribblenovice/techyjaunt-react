const HackathonThankYou = () => {
  return (
    <>
      <div className="w-screen h-screen grid place-items-center bg-center bg-no-repeat bg-gray-700 bg-blend-multiply bg-cover hackathon">
        <div className=" w-[90%] sm:w-[80%] gap-y-5">
          <div className="speakers rounded-lg grid place-items-center p-5 md:p-20">
            ...
            <a
              href="https://chat.whatsapp.com/HhWnecW7kZ72qmkZ6PXNNL"
...
export default HackathonThankYou;
