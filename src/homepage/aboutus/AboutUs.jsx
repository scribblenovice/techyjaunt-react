            ...
            <div className="lg:max-w-md">
              <Fade bottom>
                ...
                <p className="font-normal mb-10 text-base leading-7 text-gray-500">
                  ...
                  emerging technologies and relevant tech skills. We aim to be
                  the bridge to Journey Africans into tech, one person at a
                  time, onboarding, educating, and training tech enthusiasts on
                  relevant tech skills while solving problems by building
                  products that can make the world a better place and easy place
                  to live in.
                </p>
              </Fade>
                      ...
                      <span className="text-blue-500">
                        ...
                        >
                          ...
                          <line
                            ...
                            y2="12"
                          />
                          <path d="M10,25.967C10,26.537,9.537,27,8.967,27h0c-0.544,0-0.995-0.422-1.031-0.965l-0.438-6.57C7.48,19.204,7.263,19,7,19h0  c-0.263,0-0.48,0.204-0.498,0.466l-0.438,6.57C6.028,26.578,5.577,27,5.033,27h0C4.463,27,4,26.537,4,25.967V13c0-1.105,0.895-2,2-2  h6v2h-1c-0.552,0-1,0.448-1,1V25.967z" />
                          <polyline
