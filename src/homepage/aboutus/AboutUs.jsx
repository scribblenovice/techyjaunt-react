...
const AboutUs = () => {
  return (
    <section name="about" className="border py-10 lg:py-20 bg-stone-100 font-poppins w-[9]" id="about">
      <div className="w-[90%] smw-[80%] py-4 mx-auto lg:py-6">
        <div className="flex flex-wrap">
          <div className="w-full mb-10 lg:w-1/2 lg:mb-0">
            <div className="lg:max-w-md border">
...
-96 59 -4 0 -37 -23 -73 -50z"
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 border">
            <div className="space-y-2 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-300 before:to-transparent">
              ...
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                ...
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-4 rounded border border-slate-200 shadow">
                  <div className="flex items-center justify-between space-x-2 mb-1">
                    {/* <div className="font-bold text-slate-900">2nd Cohort</div> */}
                    <time className="font-caveat font-medium text-blue-500">
                      09/05/2023
                    </time>
                  </div>
