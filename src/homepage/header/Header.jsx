    ...
    <header className="flex justify-center h-fit py-20 launchpad-jumbo bg-center bg-cover bg-blend-multiply bg-gray-800">
      <div className="mt-10 w-[90%] sm:w-[80%] mx-auto grid grid-cols-1 gap-y-10 lg:gap-y-0 lg:grid-cols-2 lg:gap-x-10 place-items-center">
        <div className="h-full md:h-[70%] flex flex-col justify-around md:justify-evenly">
          ...
          <p className="font-normal text-white mb-5 text-sm sm:text-base leading-7">
            Start a career in{" "}
            <span className="inline-block min-w-[200px] text-center">
              <TypingAnimation />{" "}
            </span>{" "}
            + Six(6) month mentorship from the best industry leaders from around
            the world
          </p>
          <button
            onClick={() => {
            ...
            className="py-3 my-4 px-10 bg-blue-500 rounded-md text-white hover:scale-105 transition-all duration-200 ease-in text-base lg:text-xl"
          >
            APPLY HERE FOR FREE
          </button>
