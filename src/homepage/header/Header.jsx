...
const Header = () => {
  return (
    <section className="flex justify-center h-fit py-20 lg:h-[100vh] launchpad-jumbo bg-center bg-cover bg-blend-multiply bg-gray-800">
      <div className="mt-10 w-[90%] sm:w-[80%] mx-auto grid grid-cols-1 gap-y-10 lg:gap-y-0 lg:grid-cols-2 lg:gap-x-10 place-items-center">
        <div className="h-full md:h-[70%] flex flex-col justify-around md:justify-evenly">
          ...
          <p className="text-white mb-5 text-sm sm:text-base leading-7">
